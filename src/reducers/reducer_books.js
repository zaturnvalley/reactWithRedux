export default function() {
  return [
    { title: 'East of Eden', 
      pages: 601, 
      about: `East of Eden is a novel by Nobel Prize winner John Steinbeck, published in September 1952. 
            Often described as Steinbeck\'s most ambitious novel, East of Eden brings to life the intricate details of two families, 
            the Trasks and the Hamiltons, and their interwoven stories. The novel was originally addressed to Steinbeck\'s young sons, 
            Thom and John (then 6 and 4 years old, respectively). Steinbeck wanted to describe the Salinas Valley for them in detail: 
    ...
    { title: 'The Brothers Karamazov', 
      pages: 824,
      about: `The Brothers Karamazov, also translated as The Karamazov Brothers, is the final novel by the Russian author Fyodor Dostoyevsky. 
            Dostoyevsky spent nearly two years writing The Brothers Karamazov, which was published as a serial in The Russian Messenger from 
            January 1879 to November 1880. The author died less than four months after its publication.
    ...
    { title: 'Kafka on the Shore', 
      pages: 480,
      about: `A 2002 novel by Japanese author Haruki Murakami. Comprising two distinct but interrelated plots, the narrative runs back and forth between 
            both plots, taking up each plotline in alternating chapters. The odd chapters tell the 15-year-old Kafka's story as he runs away from his father's 
            house to escape an Oedipal curse and to embark upon a quest to find his mother and sister. After a series of adventures, he finds shelter in a quiet, 
            private library in Takamatsu, run by the distant and aloof Miss Saeki and the intelligent and more welcoming Oshima. There he spends his days reading 
            the unabridged Richard Francis Burton translation of One Thousand and One Nights and the collected works of Natsume Sōseki until the police begin inquiring 
